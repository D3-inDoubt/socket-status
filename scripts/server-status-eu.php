<html>
<!-- MetaTag to refresh the site every 58seks -->
<meta http-equiv="refresh" content="58; URL=server-status-eu.php" />

<!-- Countdown Script for the footer area-->
...
<?php
if(check("IP", "PORT")) echo ("<img src='https://img.indoubt.at/tera/misc/online.png' alt='online'>");
...
<div align="center"><p class="coded">copyleft<br>coded 2012 by<a href="https://d3.indoubt.at/" title="D3 .inDoubt.Depl.Dep." target="_blank"><br><b>D&sup3;</b><br>.in<b>D</b>oubt.<b>D</b>epl.<b>D</b>ep.</a></p></div>
</div>
</body>
</html>
